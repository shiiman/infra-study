...
> **★ 実際の人数は 12名(受講者11 + 講師1)で確定した(2026-09-16)★**
> 本メモの見積もりは20人前提のままにしてある。**申請値も20人前提で通してあるので、
> 実人数に対しては大幅に余裕がある。** 途中参加で増えても20人までは再申請が不要。
> ただし `BACKEND-SERVICES-per-project`(75で固定・引き上げ不可)だけは
> 人数が増えると効いてくるので、20人を超えるなら7章の残骸対策を再確認すること。
