...
原則3週に1回・月曜or木曜・2時間。第4回・第5回・第9回は木曜。

| 回 | 日程 | 間隔 | テーマ |
|---|---|---|---|
| 1 | 2026-10-05(月) 14-16時 | — | GCP基礎 / IAM / Terraform |
| 2 | 2026-10-26(月) 14-16時 | 3週 | ネットワーク |
| 3 | 2026-11-16(月) 14-16時 | 3週 | コンピューティング |
| 4 | 2026-12-10(木) 15-17時 | 24日 | データベース |
| 5 | 2026-12-24(木) 17-19時 | 14日 | コンテナ |
| 6 | 2027-01-18(月) 11-13時 | 25日 | ストレージ + CDN |
| 7 | 2027-02-08(月) 11-13時 | 3週 | CI/CD |
| 8 | 2027-03-01(月) 14-16時 | 3週 | 監視・運用 + その他リソース |
| 9 | 2027-03-18(木) 15-17時 | 17日 | 試験対策(ACE / CDL) |
| 10 | 2027-04-05(月) 11-13時 | 18日 | 実践テスト + 総まとめ |

**避けた月曜**: 10/12(スポーツの日)、11/23(勤労感謝の日)、12/28(年末)、1/11(成人の日)、3/22(春分の日の振替休日)

**受験期間**: 第9回(3/18) で受験申込まで済ませ、第10回(4/5) までの18日間を受験期間に充てる。
...
### 第1回 GCP基礎 / IAM / Terraform (2026-10-05 月 14-16時)
...
### 第2回 ネットワーク (2026-10-26 月 14-16時)
...
### 第3回 コンピューティング (2026-11-16 月 14-16時)
...
### 第4回 データベース (2026-12-10 木 15-17時)
...
### 第6回 ストレージ + CDN (2027-01-18 月 11-13時)
...
### 第8回 監視・運用 + その他リソース (2027-03-01 月 14-16時)
...
### 第10回 実践テスト + 総まとめ (2027-04-05 月 11-13時)
...
- [x] **受講者ごとのビルド用サービスアカウントの作成**(第7回・講師) — **完了**
  ...
  **15名分を作成・付与済み**(2026-09-16 に12名、2026-09-18 に3名追加)。
  冪等なので再実行して確認できる。**人が増えたらその人の分だけ流せばよい。**
...
- [x] 対象者の確定 — **2026-09-18 時点で受講者14名 + 講師1名 = 15名。**
  (2026-09-16 に12名で確定 → 2026-09-18 に3名追加)
  ...
  **社用メールのローカル部の `_` を `-` に置き換えたもの**
  ...
  - 15名の最長は18文字。全制約(SA / GCSバケット名 / Redis instance id)に収まる
...
- [x] 受講者への権限付与 — **2026-09-16 に完了。**
  ...
  **12ロールを付与 + メンバーを追加**した(2026-09-16 に12名、2026-09-18 に3名で計15名)。
  **ロールはグループに付いているので、人が増えたらグループに入れるだけで権限が効く。**
  付与のやり直しは不要。
...
|---|---|
| Terraform が入っていない | 判明済み。第1回 S66 でインストール手順を追加 |
