...
| 作業 | 対象 | 備考 |
|---|---|---|
| **スライドの Google スライドへの流し込み** | 全10回 | 手作業。原稿の `[本文]` `[図版]` に従う |
| **新規作図** | 全10回で計50枚ほど | 各回の付録Bに一覧あり |
| **アンケート Google Form の作成** | 全10回 + 全体 | 各回 S39〜S43 あたり |
| 試験1の Google Form 化 | 第10回 | `lesson10/exam1_questions.md` の15問 |
